...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lgvid.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -static -shared -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lgvid.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/1200762390/bbi_dll_context.o: ../lgvidsubs_shared/bbi_dll_context.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1200762390
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -Isrc -Isrc/ffmpeg -I../lgvidsubs_shared -I../../ffmpeg-1.1 -std=c++98  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1200762390/bbi_dll_context.o ../lgvidsubs_shared/bbi_dll_context.cpp

${OBJECTDIR}/_ext/1200762390/bbi_subtitle.o: ../lgvidsubs_shared/bbi_subtitle.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1200762390
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -Isrc -Isrc/ffmpeg -I../lgvidsubs_shared -I../../ffmpeg-1.1 -std=c++98  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1200762390/bbi_subtitle.o ../lgvidsubs_shared/bbi_subtitle.cpp

${OBJECTDIR}/_ext/1200762390/bbi_string_helper.o: ../lgvidsubs_shared/bbi_string_helper.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1200762390
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -Isrc -Isrc/ffmpeg -I../lgvidsubs_shared -I../../ffmpeg-1.1 -std=c++98  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1200762390/bbi_string_helper.o ../lgvidsubs_shared/bbi_string_helper.cpp

${OBJECTDIR}/_ext/1200762390/bbi_srt_parser.o: ../lgvidsubs_shared/bbi_srt_parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1200762390
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -Isrc -Isrc/ffmpeg -I../lgvidsubs_shared -I../../ffmpeg-1.1 -std=c++98  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1200762390/bbi_srt_parser.o ../lgvidsubs_shared/bbi_srt_parser.cpp

${OBJECTDIR}/src/lgvid.o: src/lgvid.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -Isrc -Isrc/ffmpeg -I../lgvidsubs_shared -I../../ffmpeg-1.1 -std=c++98  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lgvid.o src/lgvid.cpp
